...
<div align="justify">
Graduado no <code>eixo tecnológico de informação e comunicação</code> pela <a href="https://vitalbrasil.com.br/" target="_blank">Escola Técnica Vital Brasil</a> (2014-2020), onde teve seu primeiro contato com diversas linguagens de programação. Neste período adquiriu experiência em banco de dados (MySQL), C, C++, C#, CSS, PHP, HTML, JavaScript e Java. Atualmente, cursa <code>Análise e Desenvolvimento de Sistemas</code> no <a href="https://newtonpaiva.br/" target="_blank">Centro Universitário Newton Paiva</a> (2022-2025).
